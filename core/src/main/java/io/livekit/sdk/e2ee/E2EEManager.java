...
/**
 * Manages E2EE state and coordinates encryption/decryption for a room.
...
public class E2EEManager {
     ...
     * The new key will be used for encrypting outgoing frames.
     *
    ...
    /**
     * Ratchet the key for a participant.
     * Used when receiving frames encrypted with a newer key index.
     *
