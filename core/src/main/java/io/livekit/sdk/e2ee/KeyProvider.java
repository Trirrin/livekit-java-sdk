...
/**
 * Interface for providing encryption keys for E2EE.
 * Implementations handle key storage, derivation, and rotation.
 */
public interface KeyProvider {
    ...
    /**
     * Rotate to a new key for the local participant.
     * The new key should be distributed to other participants via a secure channel.
     *
