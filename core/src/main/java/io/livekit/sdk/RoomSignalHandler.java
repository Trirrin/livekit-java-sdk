...
/**
 * Handles signaling events and delegates them to Room for state management. This class implements
 * the interface expected by SignalClient to bridge signaling layer with Room state management.
 */
