...
public final class ProtoConverter {
    ...
    public static void updateParticipantFromProto(Participant participant, LivekitModels.ParticipantInfo info) {
    ...
    public static TrackPublication trackPublicationFromProto(LivekitModels.TrackInfo info) {
        TrackPublication publication = new TrackPublication(
                info.getSid(),
                info.getName(),
                fromProto(info.getType())
        );
    ...
    public static void updateTrackPublicationFromProto(TrackPublication publication, LivekitModels.TrackInfo info) {
        publication.setSource(fromProto(info.getSource()));
        publication.setMuted(info.getMuted());
        publication.setMimeType(info.getMimeType());
    }
    ...
    public static LivekitRtc.UpdateParticipantMetadata buildMetadataUpdate(
        ...
        LivekitRtc.UpdateParticipantMetadata.Builder builder = LivekitRtc.UpdateParticipantMetadata.newBuilder();
        if (metadata != null) {
