...
public abstract class RoomEvent {
    ...
    public static class TrackSubscribed extends RoomEvent {
        ...
        public TrackSubscribed(Room room, Track track, TrackPublication publication, 
    ...
    public static class TrackUnsubscribed extends RoomEvent {
        ...
        public TrackUnsubscribed(Room room, Track track, TrackPublication publication,
                                 RemoteParticipant participant) {
            super(room);
            this.track = track;
            this.publication = publication;
    ...
    public static class DataReceived extends RoomEvent {
        ...
        public DataReceived(Room room, byte[] data, RemoteParticipant participant,
