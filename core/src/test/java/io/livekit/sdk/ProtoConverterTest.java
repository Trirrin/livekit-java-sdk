...
class ProtoConverterTest {
  ...
  void testTrackSourceConversion() {
    ...
    assertEquals(
        TrackSource.MICROPHONE, ProtoConverter.fromProto(LivekitModels.TrackSource.MICROPHONE));
    assertEquals(
        TrackSource.SCREEN_SHARE, ProtoConverter.fromProto(LivekitModels.TrackSource.SCREEN_SHARE));
    assertEquals(
        TrackSource.SCREEN_SHARE_AUDIO,
        ProtoConverter.fromProto(LivekitModels.TrackSource.SCREEN_SHARE_AUDIO));
    ...
    assertEquals(
        LivekitModels.TrackSource.MICROPHONE, ProtoConverter.toProto(TrackSource.MICROPHONE));
    assertEquals(
        LivekitModels.TrackSource.SCREEN_SHARE, ProtoConverter.toProto(TrackSource.SCREEN_SHARE));
    assertEquals(
        LivekitModels.TrackSource.SCREEN_SHARE_AUDIO,
        ProtoConverter.toProto(TrackSource.SCREEN_SHARE_AUDIO));
  ...
  void testConnectionQualityConversion() {
    assertEquals(
        ConnectionQuality.POOR, ProtoConverter.fromProto(LivekitModels.ConnectionQuality.POOR));
    assertEquals(
        ConnectionQuality.GOOD, ProtoConverter.fromProto(LivekitModels.ConnectionQuality.GOOD));
    assertEquals(
        ConnectionQuality.EXCELLENT,
        ProtoConverter.fromProto(LivekitModels.ConnectionQuality.EXCELLENT));
    assertEquals(
        ConnectionQuality.LOST, ProtoConverter.fromProto(LivekitModels.ConnectionQuality.LOST));
  }
  ...
  void testDisconnectReasonConversion() {
    assertEquals(
        ...
        ProtoConverter.fromProto(LivekitModels.DisconnectReason.CLIENT_INITIATED));
    assertEquals(
        DisconnectReason.DUPLICATE_IDENTITY,
        ProtoConverter.fromProto(LivekitModels.DisconnectReason.DUPLICATE_IDENTITY));
    assertEquals(
        DisconnectReason.SERVER_SHUTDOWN,
        ProtoConverter.fromProto(LivekitModels.DisconnectReason.SERVER_SHUTDOWN));
    assertEquals(
        DisconnectReason.ROOM_DELETED,
        ProtoConverter.fromProto(LivekitModels.DisconnectReason.ROOM_DELETED));
  }
