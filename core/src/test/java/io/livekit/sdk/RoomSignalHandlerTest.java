...
class RoomSignalHandlerTest {
    ...
    void testJoinResponseCreatesLocalParticipant() {
        LivekitRtc.JoinResponse response = LivekitRtc.JoinResponse.newBuilder()
    ...
    void testJoinResponseWithOtherParticipants() {
        LivekitRtc.JoinResponse response = LivekitRtc.JoinResponse.newBuilder()
                ...
                .setParticipant(LivekitModels.ParticipantInfo.newBuilder()
                        ...
                        .setIdentity("local-user")
                        .build())
                .addOtherParticipants(LivekitModels.ParticipantInfo.newBuilder()
                        .setSid("PA_remote1")
    ...
    void testParticipantUpdateAddsNewParticipant() {
        // First join
        LivekitRtc.JoinResponse joinResponse = LivekitRtc.JoinResponse.newBuilder()
                .setRoom(LivekitModels.Room.newBuilder().setSid("RM_123").setName("test").build())
                .setParticipant(LivekitModels.ParticipantInfo.newBuilder()
                        .setSid("PA_local").setIdentity("local").build())
                .build();
        ...
        LivekitRtc.ParticipantUpdate update = LivekitRtc.ParticipantUpdate.newBuilder()
                .addParticipants(LivekitModels.ParticipantInfo.newBuilder()
                        .setSid("PA_new")
    ...
    void testParticipantUpdateRemovesDisconnectedParticipant() {
        ...
        LivekitRtc.JoinResponse joinResponse = LivekitRtc.JoinResponse.newBuilder()
                ...
                .setParticipant(LivekitModels.ParticipantInfo.newBuilder()
                        .setSid("PA_local").setIdentity("local").build())
                .addOtherParticipants(LivekitModels.ParticipantInfo.newBuilder()
                        .setSid("PA_remote").setIdentity("remote-user").build())
                .build();
        handler.onJoinResponse(joinResponse);
        assertEquals(1, room.getRemoteParticipants().size());
    ...
    void testRoomUpdateChangesMetadata() {
        ...
        LivekitRtc.JoinResponse joinResponse = LivekitRtc.JoinResponse.newBuilder()
                .setRoom(LivekitModels.Room.newBuilder()
                        .setSid("RM_123").setName("test").setMetadata("old").build())
                .setParticipant(LivekitModels.ParticipantInfo.newBuilder()
                        .setSid("PA_local").setIdentity("local").build())
                .build();
        handler.onJoinResponse(joinResponse);
        ...
        // Room update
        LivekitRtc.RoomUpdate update = LivekitRtc.RoomUpdate.newBuilder()
                .setRoom(LivekitModels.Room.newBuilder()
                        .setSid("RM_123").setName("test").setMetadata("new-metadata").build())
                .build();
