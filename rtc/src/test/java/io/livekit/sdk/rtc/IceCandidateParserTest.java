...
class IceCandidateParserTest {
    ...
    void testParseValidCandidate() {
        String json = "{\"candidate\":\"candidate:123 1 udp 2113937151 192.168.1.1 54321 typ host\",\"sdpMid\":\"0\",\"sdpMLineIndex\":0}";
    ...
    @Test
    void testRoundTrip() {
        RTCIceCandidate original = new RTCIceCandidate("0", 0, 
                "candidate:123 1 udp 2113937151 192.168.1.1 54321 typ host generation 0");
