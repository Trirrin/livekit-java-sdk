...
/**
 * Manages WebRTC DataChannels for reliable and lossy data transport.
 * LiveKit uses two channels: one for reliable (ordered, guaranteed delivery) and
 * one for lossy (unordered, no retransmission) data.
 */
