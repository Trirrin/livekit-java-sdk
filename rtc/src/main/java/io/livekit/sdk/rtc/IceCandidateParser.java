...
/**
 * Utility class for parsing ICE candidates from/to JSON format. LiveKit uses JSON-encoded strings
 * for ICE candidate transport.
 */
public final class IceCandidateParser {
  ...
  /**
   * Parse an ICE candidate from a JSON string. Format:
