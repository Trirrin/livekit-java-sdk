...
/** Utility class to parse LiveKit JWT tokens. Extracts claims without signature verification. */
public class TokenParser {
  ...
  /**
   * Parse a JWT token and extract claims. Note: This does NOT verify the token signature.
   *
