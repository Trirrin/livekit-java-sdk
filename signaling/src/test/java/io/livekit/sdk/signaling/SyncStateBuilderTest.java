...
class SyncStateBuilderTest {
  ...
  void testBuildWithAnswer() {
    LivekitRtc.SessionDescription answer =
        LivekitRtc.SessionDescription.newBuilder().setType("answer").setSdp("v=0...").build();
  ...
  void testBuildWithOffer() {
    LivekitRtc.SessionDescription offer =
        LivekitRtc.SessionDescription.newBuilder().setType("offer").setSdp("offer-sdp").build();
  ...
  void testBuilderChaining() {
    LivekitRtc.SessionDescription answer =
        LivekitRtc.SessionDescription.newBuilder().setType("answer").setSdp("sdp").build();

    LivekitRtc.SyncState syncState =
        new SyncStateBuilder()
            .setAnswer(answer)
